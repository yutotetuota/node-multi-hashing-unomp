...
Handle<Value> vipstar(const Arguments& args) {
    HandleScope scope;
    ...
    vipstarcoinhash(input, output, input_len);
...
void init(Handle<Object> exports) {
    ...
    exports->Set(String::NewSymbol("vipstar"), FunctionTemplate::New(vipstar)->GetFunction());
}
